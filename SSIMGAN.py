...
loss_filename = "losses_sim_{}.txt".format(time.time())
...
checkpoint_dir = './ssim_training_checkpoints'
...
@tf.function
def train_step(images, VGG, count, epoch_disc_loss, epoch_gen_loss):
...
def train(dataset, epochs, test_dataset=None):
  ...
  for epoch in range(epochs):
    ...
    for image_batch in dataset:
      ...
      d_loss, g_loss = train_step(image_batch, VGG, tf.constant(count), epoch_disc_loss, epoch_gen_loss)
      count += 1
